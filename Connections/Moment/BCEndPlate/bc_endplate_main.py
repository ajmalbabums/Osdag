...
from model import get_columndata
...
class DesignPreference(QDialog):
    ...
    def column_preferences(self, designation, ultimateStrength_Column, yieldStrength_Column):
        ...
        if (self.ui.lineEdit_Depth_Column.text() != "" and self.ui.lineEdit_FlangeWidth_Column.text() != "" and self.ui.lineEdit_FlangeThickness_Column.text() != ""
    ...
    def beam_preferences(self, designation, ultimateStrength_Beam, yieldStrength_Beam):
        ...
        if (self.ui.lineEdit_Depth_Beam.text() != "" and self.ui.lineEdit_FlangeWidth_Beam.text() != "" and self.ui.lineEdit_FlangeThickness_Beam.text() != ""
    ...
    def add_ColumnPref(self):
        ...
        if (self.ui.lineEdit_Designation_Column.text()=="" or self.ui.lineEdit_Mass_Column.text()=="" or self.ui.lineEdit_SectionalArea_Column.text()=="" or self.ui.lineEdit_Depth_Column.text()==""
    ...
    def add_BeamPref(self):
        ...
        if (self.ui.lineEdit_Designation_Beam.text()=="" or self.ui.lineEdit_Mass_Beam.text()=="" or self.ui.lineEdit_SectionalArea_Beam.text()=="" or self.ui.lineEdit_Depth_Beam.text()==""
    ...
    def import_BeamPref(self):
        ...
        for rowNum in range(2, sheet.max_row+1):
            ...
            c = conn.cursor()
            c.execute('''INSERT INTO Beams (Designation,Mass,Area,D,B,tw,T,FlangeSlope,R1,R2,Iz,Iy,rz,ry,
                           Zz,zy,Zpz,Zpy,Source) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)''', (designation, mass, area,
                                                                                                     d, b, tw, t,
                                                                                                     flangeSlope, r1
                                                                                                                           ,
                                                                                                     r2, iz, iy, rz, ry,
    ...
    def import_ColumnPref(self):
        ...
        for rowNum in range(2, sheet.max_row+1):
            ...
            c = conn.cursor()
            c.execute('''INSERT INTO Columns (Designation,Mass,Area,D,B,tw,T,R1,R2,Iz,Iy,rz,ry,
                           Zz,zy,Zpz,Zpy,FlangeSlope,Source) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)''', (designation, mass, area,
                                                                                                     d, b, tw, t,
                                                                                                     r1, r2, iz, iy, rz, ry,
                                                                                                     zz, zy
                                                                                                                           ,
...
class Maincontroller(QMainWindow):
    ...
    def __init__(self, folder):
        ...
        #self.column_pref = designPreference_column(str(self.ui.combo_columnSec.currentText()),self.ui.txt_Fu.text(),self.ui.txt_Fy.text())
        ...
        #self.ui.btn_Design.clicked.connect(self.column_pref.set_columnPref())
