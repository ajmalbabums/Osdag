...
class IS800_2007(object):
    ...
    def cl_3_7_3_class(self, cl_3_7_Table_2, e, r1):
        ...
        if cl_3_7_Table_2[0]["outstanding_elements_compression_flange"]["rolled"] <= 9.4 * e:
            ...
            return "class1"
        elif  9.4 * e >= cl_3_7_Table_2[0]["outstanding_elements_compression_flange"]["welded"] > 8.4 * e:
            return "class2"
        elif 13.6 * e >= cl_3_7_Table_2[0]["outstanding_elements_compression_flange"]["welded"] > 9.4 * e:
            return "class3"
        elif cl_3_7_Table_2[0]["internal_elements_compression_flange"]["compression_due_to_bending"] <= 29.3 * e:
            return "class1"
        elif 33.5 * e >= cl_3_7_Table_2[0]["internal_elements_compression_flange"]["compression_due_to_bending"]>29.3*e:
            return "class2"
        elif 42 * e >= cl_3_7_Table_2[0]["internal_elements_compression_flange"]["compression_due_to_bending"] > 33.5 * e:
            return "class3"
            ...
            return "class1"
        elif 10.5 * e >= cl_3_7_Table_2[0]["angle_compression_due_to_bending"][0] > 9.4 * e and \
                10.5 * e <= cl_3_7_Table_2[0]["angle_compression_due_to_bending"][1] > 9.4 * e:
            return "class2"
        elif 15.7 * e <= cl_3_7_Table_2[0]["angle_compression_due_to_bending"][0] > 10.5 * e and \
                15.7 * e <= cl_3_7_Table_2[0]["angle_compression_due_to_bending"][1] > 10.5 * e:
            return "class3"
            ...
            return "class1"
        elif 10.5 * e >= cl_3_7_Table_2[0]["outstanding_leg_in_back_to_back_in_a_double_angle_member"] > 9.4 * e:
            return "class2"
        elif 15.7 * e >= cl_3_7_Table_2[0]["outstanding_leg_in_back_to_back_in_a_double_angle_member"] > 10.5 * e:
            return "class3"
        elif cl_3_7_Table_2[0]["outstanding_leg_of_an_angle_with_its_back_in_cont_contact_with_another_component"] <= 9.4 * e:
            return "class1"
        elif 10.5 * e >= cl_3_7_Table_2[0]["outstanding_leg_of_an_angle_with_its_back_in_cont_contact_with_another_component"] > 9.4 * e:
            return "class2"
        elif 15.7 * e >= cl_3_7_Table_2[0]["outstanding_leg_of_an_angle_with_its_back_in_cont_contact_with_another_component"] > 10.5 * e:
            return "class3"
        elif cl_3_7_Table_2[0]["stem_of_tsection_rolled_or_cut_from_a_rolled_IorH_section"] <= 8.4 * e:
            return "class1"
        elif 9.4 * e >= cl_3_7_Table_2[0]["stem_of_tsection_rolled_or_cut_from_a_rolled_IorH_section"] > 8.4 * e:
            return "class2"
        elif 18.9 * e >= cl_3_7_Table_2[0]["stem_of_tsection_rolled_or_cut_from_a_rolled_IorH_section"] > 9.4 * e:
            return "class3"
        elif cl_3_7_Table_2[0]["circular_hollow_tube_including_welded_tube_subjected_to"][0] <= 42 * e * e:
            return "class1"
        elif 52 * e * e >= cl_3_7_Table_2[0]["circular_hollow_tube_including_welded_tube_subjected_to"][0] > 42 * e * e:
            return "class2"
        elif 146 * e * e >= cl_3_7_Table_2[0]["circular_hollow_tube_including_welded_tube_subjected_to"][0] > 52 * e * e:
            return "class3"
            ...
            return "class1"
        elif r1 < 0 and 84 * e / (1 + r1) > cl_3_7_Table_2[0]["web_of_an_I_or_H_section"]["general"] <= 105 * e / (1 + r1):
            return "class2"
        elif r1 > 0 and 84 * e / (1 + r1) > cl_3_7_Table_2[0]["web_of_an_I_or_H_section"]["general"] <= 105 * e / (1 + 1.5 * r1):
            return "class2"
